                      ...
                      itemBuilder: (BuildContext context, int index) {
                        List<Categorylist> categories =
                            state.homepagemodel.categorylist.length > 6
                                ? state.homepagemodel.categorylist.sublist(0, 6)
                                : state.homepagemodel.categorylist;
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => CategoryPage(
                                        categoryId: state.homepagemodel
                        ...
                        return Padding(
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              title: Text(
                                  state.homepagemodel.joblist[index].jobType),
                              subtitle: Text(state
                                  .homepagemodel.joblist[index].jobLocation),
                              trailing: Container(
